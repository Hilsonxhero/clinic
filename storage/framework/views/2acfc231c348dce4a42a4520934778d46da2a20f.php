...
<?php $__env->startSection('content'); ?>
    <form id="kt_ecommerce_add_category_form" action="<?php echo e(route('panel.users.update', $user->id)); ?>" method="post"
...
<?php $component = $__env->getContainer()->make(App\View\Components\FileUpload::class, ['name' => 'profile','value' => ''.e($user->profile).'']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = \App\Models\User::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"
                                <?php if($user->status == $status): ?> selected="selected" <?php endif; ?>><?php echo app('translator')->get($status); ?></option>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($user->username).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($user->email).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
<?php unset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($user->phone).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
<?php unset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7); ?>
                        ...
                        <div class="d-flex fv-row">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                ...
                                <input class="form-check-input me-3" name="is_superuser" type="radio" value="0"
                                    ...
                                    <?php if(!$user->is_superuser): ?> checked="true" <?php endif; ?>>
                                <!--end::Input-->
                                <!--begin::Label-->
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/users/edit.blade.php ENDPATH**/ ?>