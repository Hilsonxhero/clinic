<input <?php echo e($disabled ? 'disabled' : ''); ?> <?php echo $attributes->merge(['class' => 'form-control mb-2']); ?> type="<?php echo e($type); ?>" name="<?php echo e($name); ?>"
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\clinic\resources\views/components/input.blade.php ENDPATH**/ ?>