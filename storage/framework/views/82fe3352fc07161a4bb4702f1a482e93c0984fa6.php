    ...
    <div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
        ...
        <div class="aside-logo flex-column-auto" id="kt_aside_logo">
            ...
            <a href="../../demo1/dist/index.html">
                <img alt="Logo" src="<?php echo e(asset('panel/media/logos/logo-1-dark.svg')); ?>" class="h-25px logo" />
            </a>
            <!--end::Logo-->
            <!--begin::Aside toggler-->
        ...
        <div class="aside-menu flex-column-fluid">
            ...
            <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.dashboard')); ?>">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.categories.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.articles.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.users.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    <div class="menu-item">
                        <a class="menu-link"
                            ...
                            <span class="menu-title">آمار</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.members.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <span class="menu-title">اعضای کلینیک</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link"
                            ...
                            <span class="menu-title">روش های درمان</span>
                        </a>
                    </div>

                    <div class="menu-item">
                        <a class="menu-link" href="<?php echo e(route('panel.services.index')); ?>">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <span class="menu-title">خدمات ما</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <div class="menu-content pt-8 pb-2">
                            <span class="menu-section text-muted text-uppercase fs-8 ls-1">عمومی</span>
                        </div>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link"
                            ...
                            <span class="menu-title">مدیریت بنر ها</span>
                        </a>
                    </div>
                    ...
                    <div class="menu-item">
                        <a class="menu-link"
                            ...
                            <span class="menu-title">اطلاعات کاربری</span>
                        </a>
                    </div>
...
<?php /**PATH C:\wamp64\www\clinic\resources\views/components/panel/sidebar.blade.php ENDPATH**/ ?>