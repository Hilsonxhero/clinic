<textarea id="editor" class="editor-ui" name="<?php echo e($name); ?>"><?php echo $value; ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\clinic\resources\views/components/text-editor.blade.php ENDPATH**/ ?>