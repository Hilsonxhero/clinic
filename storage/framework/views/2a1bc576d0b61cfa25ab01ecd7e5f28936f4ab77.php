...
<?php $__env->startSection('content'); ?>
    <form id="kt_ecommerce_add_category_form" action="<?php echo e(route('panel.articles.update', $article->id)); ?>" method="post"
...
<?php $component = $__env->getContainer()->make(App\View\Components\FileUpload::class, ['name' => 'banner','value' => ''.e($article->banner).'']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = \App\Models\Article::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"
                                <?php if($article->status == $status): ?> selected="selected" <?php endif; ?>>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($article->title).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>"
                                        <?php if($article->category_id == $category->id): ?> selected="selected" <?php endif; ?>>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TextEditor::class, ['name' => 'body','value' => ''.e($article->body).'']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TextArea::class, ['name' => 'description','value' => ''.e($article->description).'']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TagInput::class, ['name' => 'tags','placeholder' => 'کلمات کلیدی','value' => ''.e($article->tags_data).'']); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($article->meta->title).'']); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($article->meta->description).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
<?php unset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7); ?>
...
<?php $component->withAttributes(['class' => '']); ?>
                            <?php if (isset($component)) { $__componentOriginal26cd0b5fd349a60abbafc132e9d087b7dc8e155d = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\TagInput::class, ['name' => 'meta_keywords','placeholder' => 'کلمات کلیدی متا','value' => ''.e($article->meta->keywords_data).'']); ?>
<?php $component->withName('tag-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(asset('panel/plugins/custom/ckeditor/ckeditor.js')); ?>"></script>
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/articles/edit.blade.php ENDPATH**/ ?>