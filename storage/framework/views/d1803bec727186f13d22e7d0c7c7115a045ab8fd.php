...
<?php $__env->startSection('content'); ?>
    <form id="kt_ecommerce_add_category_form" action="<?php echo e(route('panel.services.update', $service->id)); ?>" method="post"
...
<?php $component = $__env->getContainer()->make(App\View\Components\FileUpload::class, ['name' => 'profile','value' => ''.e($service->icon).'']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = \App\Models\Service::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>"
                                <?php if($service->status == $status): ?> selected="selected" <?php endif; ?>><?php echo app('translator')->get($status); ?></option>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($service->title).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($category->id); ?>"
                                        <?php if($service->category_id == $category): ?> selected="selected" <?php endif; ?>>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TextEditor::class, ['name' => 'description','value' => ''.e($service->description).'']); ?>
...
<?php endif; ?>
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="<?php echo e(route('panel.services.index')); ?>" id="kt_ecommerce_add_product_cancel"
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/services/edit.blade.php ENDPATH**/ ?>