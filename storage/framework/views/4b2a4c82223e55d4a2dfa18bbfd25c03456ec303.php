    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="<?php echo e(route('panel.services.create')); ?>" class="btn btn-primary">سرویس جدید</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                ...
                <tbody class="fw-bold text-gray-600">
                    <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                                ...
                                <div class="d-flex">
                                    <a href="" class="symbol symbol-50px">
                                        <span class="symbol-label"
                                            style="background-image:url(<?php echo e($service->icon); ?>);"></span>
                                    </a>
                                    <div class="ms-5">
                                        ...
                                        <div class="text-muted fs-7 fw-bolder">
                                            <?php echo truncate($service->description, 90); ?>
                            ...
                            <td>
                                <div class="badge badge-light-primary"><?php echo e($service->category ? $service->category->title : 'ندارد'); ?></div>
                            </td>
                            <td>
                                <?php switch($service->status):
                                    case (\App\Models\Service::ACTIVE_STATUS): ?>
                                        <div class="badge badge-light-success"><?php echo app('translator')->get($service->status); ?></div>
                                    <?php break; ?>

                                    <?php case (\App\Models\Service::INACTIVE_STATUS): ?>
                                        <div class="badge badge-light-danger"><?php echo app('translator')->get($service->status); ?></div>
                                    <?php break; ?>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="<?php echo e(route('panel.services.edit', $service->id)); ?>"
                                    ...
                                    <a data-id="<?php echo e(json_encode($service->id)); ?>"
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/services/index.blade.php ENDPATH**/ ?>