...
<?php $__env->startSection('content'); ?>
    <form id="kt_ecommerce_add_category_form" action="<?php echo e(route('panel.categories.update', $category->id)); ?>" method="post"
...
<?php $component = $__env->getContainer()->make(App\View\Components\FileUpload::class, ['name' => 'thumb','value' => ''.e($category->icon).'']); ?>
...
<?php $component->withAttributes([]); ?>
                        <?php $__currentLoopData = \App\Models\Category::$statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($status); ?>" <?php if($category->status == $status): ?> selected="selected" <?php endif; ?>>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($category->title).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes(['class' => 'fv-row col-md-6']); ?>
                            <?php if (isset($component)) { $__componentOriginal9664ac210be45add4be058f3177c16028511e71a = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Select::class, ['name' => 'parent_id','placeholder' => 'انتخاب  دسته بندی']); ?>
<?php $component->withName('select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($category->parent_id).'']); ?>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($categoryItem->id); ?>"
                                        <?php if($category->parent_id == $categoryItem->id): ?> selected="selected" <?php endif; ?>>
                                        <?php echo e($categoryItem->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal9664ac210be45add4be058f3177c16028511e71a)): ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TextEditor::class, ['name' => 'description','value' => ''.e($category->description).'']); ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($category->meta->title).'']); ?>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['value' => ''.e($category->meta->description).'']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7)): ?>
<?php $component = $__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7; ?>
<?php unset($__componentOriginal11c02d5af8eef3b9ca8b54c54983d5cb581e68d7); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\TagInput::class, ['name' => 'meta_keywords','placeholder' => 'کلمات کلیدی متا','value' => ''.e($category->meta->keywords_data).'']); ?>
...
<?php endif; ?>
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="<?php echo e(route('panel.categories.index')); ?>" id="kt_ecommerce_add_product_cancel"
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/categories/edit.blade.php ENDPATH**/ ?>