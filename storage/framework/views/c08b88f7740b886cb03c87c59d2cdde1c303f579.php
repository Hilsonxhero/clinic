        ...
        <div class="container pt-lg-4">
            <div class="row pb-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="fs-sm pb-lg-3 mb-4">Proin ipsum pharetra, senectus eget scelerisque varius pretium platea
                        velit.
                        Lacus, eget eu vitae nullam proin turpis etiam mi sit. Non feugiat feugiat egestas nulla nec.
                        Arcu tempus,
            ...
            <p class="fs-xs text-center text-md-start pb-2 pb-lg-0 mb-0">
                ...
                <a class="nav-link d-inline-block p-0" href="https://createx.studio/" target="_blank"
                    rel="noopener">Createx
                    Studio</a>
            </p>
        </div>
    </footer>
</div>
<?php /**PATH C:\wamp64\www\clinic\resources\views/components/footer.blade.php ENDPATH**/ ?>