    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="<?php echo e(route('panel.articles.create')); ?>" class="btn btn-primary">مقاله جدید</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                        ...
                        <tr>
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="" class="symbol symbol-50px">
                                        <span class="symbol-label"
                                            style="background-image:url(<?php echo e($article->banner); ?>);"></span>
                                    </a>
                                    <!--end::Thumbnail-->
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        ...
                                        <div class="text-muted fs-7 fw-bolder">
                                            <?php echo truncate($article->description, 80); ?>
                            ...
                            <td>
                                ...
                                <?php switch($article->status):
                                    case (\App\Models\article::PUBLISHED_STATUS): ?>
                                        <div class="badge badge-light-success"><?php echo app('translator')->get($article->status); ?></div>
                                    <?php break; ?>

                                    <?php case (\App\Models\article::UNPUBLISHED_STATUS): ?>
                                        <div class="badge badge-light-danger"><?php echo app('translator')->get($article->status); ?></div>
                                    <?php break; ?>
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a href="<?php echo e(route('panel.articles.edit', $article->id)); ?>"
                                    ...
                                    <a data-id="<?php echo e(json_encode($article->id)); ?>"
...
<?php echo $__env->make('layouts.panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/panel/articles/index.blade.php ENDPATH**/ ?>