...
<section class="position-relative pt-md-3 pt-lg-5 mb-md-3 mb-lg-5">
    <div class="container position-relative zindex-5 pt-5">
        <div class="row mt-4 pt-5">
            <div class="col-xl-4 col-lg-5 text-center text-lg-end pb-3 pb-md-4 pb-lg-0">
                <h1 class="fs-xl text-uppercase">عنوان تست</h1>
                <h3 class="display-4 pb-md-2 pb-lg-4">لورم ایپسوم متن ساختگی </h3>
            ...
            <div class="col-xl-5 col-lg-6 offset-xl-1 position-relative zindex-5 mb-5 mb-lg-0">
                <div class="rellax card bg-primary border-0 shadow-primary py-2 p-sm-4 p-lg-5" data-rellax-speed="-1"
                    ...
                    <div class="card-body p-lg-3">
                        <h2 class="text-light pb-1 pb-md-3">Silicon Medical Center</h2>
                        <p class="fs-lg text-light pb-2 pb-md-0 mb-4 mb-md-5">Our medical center provides a wide
                            range of health
                            care services. We use only advanced technologies to keep your family happy and
                            healthy, without any
        ...
        <div class="row align-items-end">
            <div class="col-lg-6 d-none d-lg-block">
                <img src="assets/img/hero-img-2.jpg" class="rellax rounded-3" alt="Image" data-rellax-speed="1.35"
    ...
    <div class="d-none d-lg-block position-absolute top-0 start-0 w-50 d-flex flex-column ps-3"
        style="height: calc(100% - 108px);">
        <div class="w-100 h-100 overflow-hidden bg-position-center bg-repeat-0 bg-size-cover"
            style="background-image: url(assets/img/hero-img-1.jpg); border-bottom-left-radius: .5rem;"></div>
    </div>
</section>
            ...
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col">
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/cardiology.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                                <h3 class="h5 pb-2 mb-1">Cardiology</h3>
                                <p class="pb-2 mb-1">Id mollis consectetur congue egestas egestas suspendisse
                                    blandit justo.</p>
                                <a href="services-single-v2.html"
                                    class="btn btn-link justify-content-end stretched-link px-0">
                                    اطلاعات بیشتر
                    ...
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/scalpel.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                    ...
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/x-ray.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                ...
                <div class="col">
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/stethoscope.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                    ...
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/lungs.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                    ...
                    <div class="card card-hover bg-secondary border-0 mb-4">
                        <div class="card-body d-flex align-items-start">
                            <div class="flex-shrink-0 bg-light rounded-3 p-3">
                                <img src="assets/img/tooth.svg" width="28" alt="Icon">
                            </div>
                            <div class="pe-4">
                ...
                <div class="col-xl-5 col-lg-6" style="margin-top: -80px;">
                    ...
                    <div class="swiper-tabs mx-auto" style="max-width: 526px;">
                        <div id="image-1" class="swiper-tab active">
                            <img src="assets/img/02.jpg" class="rounded-3" alt="Image">
                        </div>
                ...
                "nextEl": "#next"
                        ...
                        <div class="swiper-wrapper text-center text-lg-start">
                            ...
                            <div class="swiper-slide pb-4" data-swiper-tab="#image-1">
                                <h2 class="h1 mb-4">New Service — Start Your Care <span
                                        class="text-success">Online</span> Now</h2>
                                <p class="pb-2 pb-xl-0 mb-4 mb-xl-5">Morbi lacus vulputate mauris ut et nunc,
                                    tempor. Placerat augue
                                    eu amet feugiat mi sagittis velit. Sed suscipit nunc suspendisse morbi
                                    pharetra libero
                                    consectetur. Proin eros sollicitudin augue tempus. Aliquet id sit donec
                                    aliquam.</p>
                            ...
                            <div class="swiper-slide pb-4" data-swiper-tab="#image-2">
                                <h2 class="h1 mb-4">Support Groups for <span class="text-danger">Depression</span> &amp;
                                    Anxiety
                                </h2>
                                <p class="pb-2 pb-xl-0 mb-4 mb-xl-5">Magna cursus feugiat sed sodales praesent
                                    vehicula integer
                                    arcu. Felis duis lectus felis, tempus aliquet quis non. At integer
                                    consectetur eget nunc, fames.
                                    Et facilisi vel, luctus sed interdum vitae nec, velit. Maecenas purus et
                                    pharetra, at volutpat
                                    aenean.</p>
                ...
                <div class="swiper-slide h-auto pt-4">
                    <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                        <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                            ...
                            <blockquote class="card-body pb-3 mb-0">
                                <p class="mb-0">Vivamus iaculis facilisis pretium. Pellentesque vitae mi odio.
                                    Donec imperdiet
                        ...
                        <figcaption class="d-flex align-items-center ps-4 pt-4">
                            <img src="assets/img/avatar/37.jpg" width="48" class="rounded" alt="Cameron Williamson">
                            <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                ...
                                <img src="assets/img/medical/news/01.jpg" class="card-img-top" alt="Image">
                            </div>
                            ...
                            <div class="card-footer py-4">
                                <a href="#" class="d-flex align-items-center text-decoration-none">
                                    <img src="assets/img/avatar/36.jpg" class="rounded" width="48" alt="Avatar">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                ...
                                <img src="assets/img/medical/news/02.jpg" class="card-img-top" alt="Image">
                            </div>
                            <div class="card-body pb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <a href="#" class="badge fs-sm text-nav bg-secondary text-decoration-none">Healthy
                                        Tips</a>
                            ...
                            <div class="card-footer py-4">
                                <a href="#" class="d-flex align-items-center text-decoration-none">
                                    <img src="assets/img/avatar/37.jpg" class="rounded" width="48" alt="Avatar">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                ...
                                <img src="assets/img/medical/news/03.jpg" class="card-img-top" alt="Image">
                            </div>
                            <div class="card-body pb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <a href="#"
                            ...
                            <div class="card-footer py-4">
                                <a href="#" class="d-flex align-items-center text-decoration-none">
                                    <img src="assets/img/avatar/38.jpg" class="rounded" width="48" alt="Avatar">
                                    <div class="ps-3">
                    ...
                    <div class="swiper-slide h-auto pb-3">
                        <article class="card h-100 border-0 shadow-sm mx-2">
                            <div class="position-relative">
                                ...
                                <img src="assets/img/medical/news/04.jpg" class="card-img-top" alt="Image">
                            </div>
                            <div class="card-body pb-4">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <a href="#"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\clinic\resources\views/application/landing.blade.php ENDPATH**/ ?>