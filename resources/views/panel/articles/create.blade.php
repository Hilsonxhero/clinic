...
@section('content')
    <form id="kt_ecommerce_add_category_form" action="{{ route('panel.articles.store') }}" method="post"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    <x-file-upload name="banner"></x-file-upload>
                ...
                <div class="card-body pt-0">
                    ...
                    <div>
                        <x-input-group label="توضیحات ">
                            <x-text-area name="description"></x-text-area>
                        </x-input-group>
                    </div>


                    <x-input-group class="" label="کلمات کلیدی ">
                        <x-tag-input class="js-keywords" name="tags" placeholder="کلمات کلیدی "></x-tag-input>
                    </x-input-group>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10">
                        ...
                        <x-input-group class="" label="عنوان متا">
                            <x-input name="meta_title" placeholder="عنوان متا"></x-input>
                        </x-input-group>
                    ...
                    <div class="mb-10">
                        ...
                        <x-input-group class="" label="توضیحات متا">
                            <x-input name="meta_description" placeholder="توضیحات متا"></x-input>
                        </x-input-group>
                    ...
                    <div>
                        <x-input-group class="" label="کلمات کلیدی متا">
                            <x-tag-input class="js-meta-keywords" name="meta_keywords" placeholder="کلمات کلیدی متا"></x-tag-input>
                        </x-input-group>
