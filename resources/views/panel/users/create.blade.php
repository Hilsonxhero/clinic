...
@section('content')
    <form id="kt_ecommerce_add_category_form" action="{{ route('panel.users.store') }}" method="post"
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-body pt-0">
                    <div class="mb-10 fv-row row">
                        ...
                        <x-input-group class="col-md-6" label="نام کاربری">
                            <x-input name="username" placeholder="نام کاربری"></x-input>
                        </x-input-group>
                        ...
                        <x-input-group class="col-md-6" label="شماره همراه">
                            <x-input name="phone" placeholder="شماره همراه"></x-input>
                        </x-input-group>
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{ route('panel.users.index') }}" id="kt_ecommerce_add_product_cancel"
