...
@section('content')
    <form id="kt_ecommerce_add_category_form" action="{{ route('panel.users.update', $user->id) }}" method="post"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    <x-file-upload name="profile" value="{{ $user->profile }}"></x-file-upload>
                ...
                <div class="card-body pt-0">
                    ...
                    <x-select name="status" placeholder="وضعیت">
                        @foreach (\App\Models\User::$statuses as $status)
                            <option value="{{ $status }}"
                                @if ($user->status == $status) selected="selected" @endif>@lang($status)</option>
                        @endforeach
                    </x-select>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <div class="mb-10 fv-row row">
                        ...
                        <x-input-group class="col-md-6" label="نام کاربری">
                            <x-input name="username" placeholder="نام کاربری" value="{{ $user->username }}"></x-input>
                        </x-input-group>

                        <x-input-group class="col-md-6" label="ایمیل">
                            <x-input name="email" placeholder="ایمیل" value="{{ $user->email }}"></x-input>
                        </x-input-group>

                        <x-input-group class="col-md-6" label="شماره همراه">
                            <x-input name="phone" placeholder="شماره همراه" value="{{ $user->phone }}"></x-input>
                        </x-input-group>
                        ...
                        <div class="d-flex fv-row">
                            ...
                            <div class="form-check form-check-custom form-check-solid">
                                ...
                                <input class="form-check-input me-3" name="is_superuser" type="radio" value="0"
                                    ...
                                    @if (!$user->is_superuser) checked="true" @endif>
                                <!--end::Input-->
                                <!--begin::Label-->
