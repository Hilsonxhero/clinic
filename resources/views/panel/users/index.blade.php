    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="{{ route('panel.users.create') }}" class="btn btn-primary">کاربر جدید</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                                ...
                                <div class="d-flex">
                                    <a href="" class="symbol symbol-50px">
                                        <span class="symbol-label"
                                            style="background-image:url({{ $user->profile }});"></span>
                                    </a>
                                    <div class="ms-5">
                            ...
                            <td>
                                @switch($user->status)
                                    @case(\App\Models\user::ACTIVE_STATUS)
                                        <div class="badge badge-light-success">@lang($user->status)</div>
                                    @break

                                    @case(\App\Models\user::INACTIVE_STATUS)
                                        <div class="badge badge-light-danger">@lang($user->status)</div>
                                    @break
