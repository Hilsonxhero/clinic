    ...
    <div class="card card-flush">
        ...
        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
            ...
            <div class="card-toolbar">
                <!--begin::Add customer-->
                <a href="{{ route('panel.categories.create') }}" class="btn btn-primary">دسته بندی جدید</a>
                <!--end::Add customer-->
            </div>
            <!--end::Card toolbar-->
        </div>
                        ...
                        <tr>
                                ...
                                <div class="d-flex">
                                    ...
                                    <a href="" class="symbol symbol-50px">
                                        <span class="symbol-label"
                                            style="background-image:url({{ $category->icon }});"></span>
                                    </a>
                                    <!--end::Thumbnail-->
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        ...
                                        <div class="text-muted fs-7 fw-bolder">
                                            {!! truncate($category->description, 20) !!}
                                        </div>
                                        <!--end::Description-->
                                    </div>
                                </div>
                            ...
                            <td>
                                ...
                                @switch($category->status)
                                    @case(\App\Models\Category::PUBLISHED_STATUS)
                                        <div class="badge badge-light-success">@lang($category->status)</div>
                                    @break

                                    @case(\App\Models\Category::UNPUBLISHED_STATUS)
                                        <div class="badge badge-light-danger">@lang($category->status)</div>
                                    @break
                            ...
                            <td>
                                <div class="d-flex justify-content-end flex-shrink-0">
                                    ...
                                    <a data-id="{{ json_encode($category->id) }}"
