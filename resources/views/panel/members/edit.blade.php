...
@section('content')
    <form id="kt_ecommerce_add_category_form" action="{{ route('panel.members.update', $member->id) }}" method="post"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    <x-file-upload name="profile" value="{{ $member->profile }}"></x-file-upload>
                ...
                <div class="card-body pt-0">
                    ...
                    <x-select name="status" placeholder="وضعیت">
                        @foreach (\App\Models\User::$statuses as $status)
                            <option value="{{ $status }}"
                                @if ($member->status == $status) selected="selected" @endif>@lang($status)</option>
                        @endforeach
                    </x-select>
                ...
                <div class="card-body pt-0">
                    <div class="mb-10 fv-row row">
                        ...
                        <x-input-group class="col-md-6" label="نام ">
                            <x-input name="name" placeholder="نام " value="{{ $member->name }}"></x-input>
                        </x-input-group>

                        <x-input-group class="col-md-6" label="ایمیل">
                            <x-input name="email" placeholder="ایمیل" value="{{ $member->email }}"></x-input>
                        </x-input-group>

                        <x-input-group class="col-md-6" label="سن">
                            <x-input name="age" placeholder="سن" value="{{ $member->age }}"></x-input>
                        </x-input-group>

                        <x-input-group class="col-md-6" label="سمت">
                            <x-input name="direction" placeholder="سمت" value="{{ $member->direction }}"></x-input>
                        </x-input-group>
                    ...
                    <div>
                        <x-input-group label="توضیحات ">
                            <x-text-editor name="description" value="{{ $member->description }}">
                            </x-text-editor>
                        </x-input-group>
                    </div>
