...
@section('content')
    <form id="kt_ecommerce_add_category_form" action="{{ route('panel.treatments.update', $treatment->id) }}"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    <x-file-upload name="banner" value="{{ $treatment->banner }}"></x-file-upload>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <x-select name="status" placeholder="وضعیت">
                        @foreach (\App\Models\treatment::$statuses as $status)
                            <option value="{{ $status }}"
                                @if ($treatment->status == $status) selected="selected" @endif>
                                @lang($status)</option>
                        @endforeach
                    </x-select>
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                ...
                <div class="card-body pt-0">
                    <div class="mb-10 fv-row row">
                        ...
                        <x-input-group class="col-md-6" label="عنوان">
                            <x-input name="title" placeholder="عنوان" value="{{ $treatment->title }}"></x-input>
                        </x-input-group>
                            ...
                            <x-select name="category_id" placeholder="انتخاب  دسته بندی">
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->id }}"
                                        @if ($treatment->category_id == $category->id) selected="selected" @endif>
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10">
                        ...
                        <x-input-group class="" label="عنوان متا">
                            <x-input name="meta_title" placeholder="عنوان متا" value="{{ $treatment->meta->title }}">
                            </x-input>
                        </x-input-group>
                    ...
                    <div class="mb-10">
                        ...
                        <x-input-group class="" label="توضیحات متا">
                            <x-input name="meta_description" placeholder="توضیحات متا"
                                value="{{ $treatment->meta->description }}"></x-input>
                        </x-input-group>
                    ...
                    <div>
                        <x-input-group class="" label="کلمات کلیدی متا">
                            <x-tag-input class="js-meta-keywords" name="meta_keywords" placeholder="کلمات کلیدی متا"
                                value="{{ $treatment->meta->keywords_data }}"></x-tag-input>
                        </x-input-group>
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{ route('panel.treatments.index') }}" id="kt_ecommerce_add_product_cancel"
